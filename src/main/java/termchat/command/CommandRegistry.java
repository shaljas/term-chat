...
import termchat.command.handlers.WhoAmICommand;
...
public class CommandRegistry {
    ...
    public void execute(String input, CommandContext ctx) {
        ...
        commands.getOrDefault(command, (ignored, c) -> {
    ...
    private void registerCommands() {
        ...
        commands.put("/whoami", (ignored, ctx) -> new WhoAmICommand().handle(null, ctx));
        ...
        commands.put("/r", (ignored, ctx) -> new RoomsCommand().handle(null, ctx));

        commands.put("/users", (ignored, ctx) -> new UsersCommand().handle(null, ctx));
        commands.put("/u", (ignored, ctx) -> new UsersCommand().handle(null, ctx));
        ...
        commands.put("/changeroom", (args, ctx) -> new SwitchRoomCommand().handle(args, ctx));
        commands.put("/switchroom", (args, ctx) -> new SwitchRoomCommand().handle(args, ctx));
        commands.put("/switch", (args, ctx) -> new SwitchRoomCommand().handle(args, ctx));
        commands.put("/join", (args, ctx) -> new SwitchRoomCommand().handle(args, ctx));
        commands.put("/s", (args, ctx) -> new SwitchRoomCommand().handle(args, ctx));
